...
perl ${BIN}/list_through_filter_from_mat.pl ${UNIQUE}.final_list ${SGE_TASK_ID} $1 ${UNIQUE}.fa ${UNIQUE}.trans ${FNUMBER} ${UNIQUE2}.f${FNUMBER}
...
perl ${BIN}/find_seq_errors22_2.pl -d ${UNIQUE2}.f${FNUMBER}.dst,${UNIQUE2}.f${FNUMBER}.unaligned.dst -m ${UNIQUE2}.f${FNUMBER}.mat -R ${UNIQUE2}.R_file -out ${UNIQUE2}.f${FNUMBER}.err -log ${UNIQUE2}.f${FNUMBER}.log
