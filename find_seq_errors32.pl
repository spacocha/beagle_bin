...
Options:
    ...
    -R R_output_prefix        The output prefix used for the R_files (requires R/2.12.1, make sure to add this module before running this program) (required)
    -out output.err           The output file name containing the a list of errors and to be parsed into a typical OTU file format by err2list.pl (required)
    -log LOGFILE              Name of the log file where some information will be logged (required)
