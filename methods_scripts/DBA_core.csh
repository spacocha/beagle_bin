...
perl distribution_based_clustering.pl -d final.${SGE_TASK_ID}.dist -m final.${SGE_TASK_ID}.seqs.count -out final.${SGE_TASK_ID}_DBA -dsttype pair -verbose -fasta final.${SGE_TASK_ID}.fasta 
